...
namespace SQLDataProducer.Entities.Generators.XMLGenerators
{
    public class NullValueXmlGenerator : XmlGeneratorBase
    {
        public static readonly string GENERATOR_NAME = "NULL value";

        public NullValueXmlGenerator(ColumnDataTypeDefinition datatype)
