...
{
    public class IdentityIntGenerator : IntegerGeneratorBase
    {
        public static readonly string GENERATOR_NAME = "Identity From SQL Server";

        public IdentityIntGenerator(ColumnDataTypeDefinition datatype)
