...
{
    public class MilliSecondsDateTimeGenerator : DateTimeGeneratorBase
    {
        public static readonly string GENERATOR_NAME = "Miliseconds Series";

        public MilliSecondsDateTimeGenerator(ColumnDataTypeDefinition datatype)
