...
//        public Entities.ExecutionEntities.ExecutionResult Consume(IEnumerable<DataRowEntity> rows)
//        {
//            foreach (var r in rows)
//            {
//                foreach (var cell in r.Fields)
//                {
//                    Console.WriteLine("{0} = {1}", cell.FieldName, cell.Value);
//                }
