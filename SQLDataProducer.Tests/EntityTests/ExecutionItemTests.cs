...
//            var ei = new ExecutionNode(t, "orginal");
...
//        //    {
//        //        // Equal
//        //        ExecutionNode x = new ExecutionNode(new TableEntity("dbo", "peter"));
//        //        ExecutionNode y = new ExecutionNode(new TableEntity("dbo", "peter"));
//        //        ExecutionNode z = new ExecutionNode(new TableEntity("dbo", "peter"));
...
//        //        // Not equal
//        //        ExecutionNode x = new ExecutionNode(new TableEntity("dbo", "peter"));
//        //        ExecutionNode y = new ExecutionNode(new TableEntity("dbo", "henell"));
//        //        ExecutionNode z = new ExecutionNode(new TableEntity("dbo", "data producer"));
//        //        AssertEqualsDefaultBehaviour(x, y, z);
...
//                ExecutionNode ie = new ExecutionNode(table);
