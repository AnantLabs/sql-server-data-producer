...
namespace SQLDataProducer.Tests.ValueGenerators
{
    [TestFixture]
    [MSTest.TestClass]
    public class CountingUpIntegerGeneratorTest
    {
        public CountingUpIntegerGeneratorTest()
        {
        }
        ...
        {
            var gen = new CountingUpIntGenerator(new ColumnDataTypeDefinition("int", false));
