...
namespace SQLDataProducer.Tests.ValueGenerators
{
    [TestFixture]
    [MSTest.TestClass]
    public class RandomExponentialIntGeneratorTest
    {
        public RandomExponentialIntGeneratorTest()
        {
        }
        ...
        {
            var gen = new RandomExponentialIntGenerator(new ColumnDataTypeDefinition("TinyInt", false));
