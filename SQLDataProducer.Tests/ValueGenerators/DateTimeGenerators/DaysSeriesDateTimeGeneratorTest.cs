...
namespace SQLDataProducer.Tests.ValueGenerators
{
    [TestFixture]
    [MSTest.TestClass]
    public class DaysSeriesDateTimeGeneratorTest
    {
        public DaysSeriesDateTimeGeneratorTest()
        {
        }
        ...
        {
            var gen = new DaysSeriesDateTimeGenerator(new ColumnDataTypeDefinition("DateTime2(2)", false));
