...
{
    public class BooleanGenerator// : GeneratorBase<BooleanParameter>
    {
        // ValueCreatorDelegate _generator;
        // BooleanParameter _param;


        // public BooleanGenerator(ValueCreatorDelegate generator, BooleanParameter param)
